...
- `xuan-ib/history/2026-09-05-am.html` is a read-only, source-bound historical
  layout rendered by `scripts/xuan-ib-saturday-archive.mjs`, verified in CI.
- Historical source publication `65c846f`, source SHA
  `521e0aa5570b00a8a0029535c3558dad8ec7e33c`, HTML blob
  `eec28a0694dcebdb3ca7790b592ceee38a0e4fa2`; original data date and read window.
...
- Simplified headlines are source-backed extracts, not new risk calculations.
  Original full text is preserved in a folded sandboxed historical comparison.
  Order distance alone is recomputed from original published prices for sorting,
  explicitly disclosed; cancellation review flags remain inherited, not derived.
- The archive demonstrates display changes only. Shared-renderer rollout in
  future scheduled production reports still needs separate real-run acceptance.
