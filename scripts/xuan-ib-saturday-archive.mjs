...
let html=renderReport(view,{previousHtml:source,previousMeta:meta,policy:JSON.parse(fs.readFileSync(repo+'claude/xuan-ib-policy-v2.json','utf8')),enableOrderTrend:false});
